...
- [x] (Custom) รองรับประเภทและรูปแบบสินค้าประมูลขยายตัว (Goods, Service, Rental, License)
- [x] (Custom) แผงควบคุมตั้งค่าระบบหลักสามารถเพิ่ม หรือลบประเภทรูปแบบสินค้าการจัดซื้อประมูลได้ (Dynamic Item Format Management)
...
- [x] (Custom) ระบบบันทึกการเช่าครุภัณฑ์ข้ามหน่วยงาน (BU-to-BU Asset Rental Log) บันทึกข้อมูลเจ้าของสินทรัพย์และผู้ใช้งาน
- [x] (Custom) ระบบบันทึกสิทธิ์ใช้งานซอฟต์แวร์ (License Subscription Log) เก็บประวัติคีย์, จำนวนเครื่อง (Seats) และวันที่หมดอายุ
...
**Acceptance Criteria:**
- [x] สามารถตั้งค่าระยะเวลารอคอยสูงสุดสำหรับ Vendor ในการตอบรับ PO (เช่น 3 วันทำการ หรือ 72 ชั่วโมง)
- [x] หากผู้ขายยังคงเงียบเฉย ไม่มีการกดยืนยัน (Acknowledge) หรืออัปโหลดไฟล์หลังจากแจ้งเตือนทางอีเมลไปแล้วครบกำหนดเวลา ระบบจะส่ง Noti แจ้งเตือน Buyer ทันทีเพื่อดำเนินการขั้นถัดไป
- [x] Buyer สามารถกดยกเลิกสิทธิ์ผู้ชนะรายนั้นในหน้ารายละเอียดการตัดสิน และระบบจะแสดงปุ่มให้เลือกกดยืนยันให้ผู้ชนะลำดับที่ 2 (Runner-up) เป็นผู้ชนะแทน พร้อมเดินเอกสารสร้าง PO ใหม่ให้คู่ค้ารายใหม่ทันที
...
- [x] (Custom) เมื่อตรวจรับของประเภทเช่าครุภัณฑ์ (Rental) ระบบจะสร้างประวัติการเช่าในทะเบียนและบันทึกผู้รับผิดชอบโดยอัตโนมัติ
- [x] (Custom) เมื่อตรวจรับของประเภทไลเซนส์ (License) ระบบจะบันทึกรหัสสิทธิ์และกำหนดเตือนวันหมดอายุในทะเบียนโดยอัตโนมัติ
